...
|  | 汎用SSD | プロビジョンドIOPS | スループット | ColdHDD |  
| :---:  | :---:  | :---: | :---:  |:---:  |
| スループット/ボリューム | 250mib/s | 1000 mib/s | 500 mib/s | 250 mib/s |
...
### S3
   ...
   - イベント通知
     ...
     - SNS
   -  Standard
     - 別のストレージクラス移行の保存日数の制限がない
   -  Standard-IA
     - 別のストレージクラス移行の保存日数は30日
   -  署名付きURL
     - 直接S3にアップロード(webサーバなどに経由しない)
### Glacier
  - 取り出す時間
